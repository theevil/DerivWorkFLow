              ...
              <Group justify="space-between" align="center">
                ...
                <div className="flex gap-3 justify-end ml-auto">
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold">Emergency Stop</span>
                  </button>
                </div>
              </Group>
            </div>
              ...
              <div className="flex-1 min-w-96 card">
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <button className="flex-1 btn-success" onClick={() => handleManualTrigger('scan')}>
                      <IconEye size={14} className="mr-2" />
                      Market Scan
                    </button>
                    <button className="flex-1 btn-primary" onClick={() => handleManualTrigger('monitor')}>
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 btn-secondary" onClick={() => handleManualTrigger('retrain')}>
                      <IconBrain size={14} className="mr-2" />
                      Retrain AI
                    </button>
                    <button className="flex-1 btn-warning" onClick={handleHealthCheck}>
                ...
                <div className="flex justify-between items-start gap-6 min-w-max mt-6">
                  <div className="flex gap-6 flex-1 justify-center">
                    <div className="flex-1 min-w-60 neumorph-inset p-4 performance-card">
                      ...
                      <Text fw={700} className="text-title" mb="xs">Max Profit</Text>
                      <Text size="xs" className="text-caption">Best single trade</Text>
                    </div>
                    ...
                    <div className="flex-1 min-w-60 neumorph-inset p-4 performance-card">
                      ...
                      <Text fw={700} className="text-title" mb="xs">Max Loss</Text>
                      <Text size="xs" className="text-caption">Worst single trade</Text>
                    </div>

                    <div className="flex-1 min-w-60 neumorph-inset p-4 performance-card">
                      <Group justify="space-between" mb="md">
                        <div className={`retro-icon-${performance.trading_stats.total_profit > 0 ? 'turquoise' : 'coral'} rounded-lg p-2`}>
                          <IconTrendingUp size={20} />
                        </div>
                        <Text size="xl" fw={900} className={`text-${performance.trading_stats.total_profit > 0 ? 'profit' : 'loss'}`}>
                          <NumberFormatter
                      ...
                      <Text fw={700} className="text-title" mb="xs">Total P&L</Text>
                      <Text size="xs" className="text-caption">Overall performance</Text>
                    </div>
                  </div>
            ...
            <div className="card mt-5">
              <Group justify="space-between" mb="md">
                <Group gap="sm">
                  ...
                  <Text fw={700} size="lg" className="text-headline">System Alerts</Text>
                </Group>
                {alerts.length > 0 && (
              ...
              {alerts.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Text fw={700} size="lg" className="text-title mb-2">No Alerts</Text>
                  <Text size="sm" className="text-caption">Your automation system is running smoothly</Text>
                </div>
              ) : (
                <div className="space-y-3">
                  {alerts.slice(0, 3).map((alert) => (
                    <div key={alert.id} className={`p-4 rounded-xl border-2 transition-all hover:shadow-md ${
                      alert.type === 'emergency_stop' ? 'border-red-300 bg-red-50' :
                      alert.type === 'risk_warning' ? 'border-yellow-300 bg-yellow-50' :
                      alert.type === 'system_error' ? 'border-red-300 bg-red-50' :
                      'border-blue-300 bg-blue-50'
                    }`}>
                      <Group justify="space-between" align="flex-start">
                        <Group gap="sm" align="flex-start">
                          <div className={`rounded-lg p-1.5 ${
                            alert.type === 'emergency_stop' ? 'retro-icon-coral' :
                            alert.type === 'risk_warning' ? 'bg-yellow-200 text-yellow-700' :
                            alert.type === 'system_error' ? 'retro-icon-coral' :
                            'retro-icon-turquoise'
                          }`}>
                            {alert.type === 'emergency_stop' && <IconAlertTriangle size={16} />}
                            {alert.type === 'risk_warning' && <IconAlertTriangle size={16} />}
                            {alert.type === 'system_error' && <IconX size={16} />}
                            {alert.type === 'position_closed' && <IconInfoCircle size={16} />}
                          </div>
                          <Box>
                            <Text fw={700} size="sm" className="text-title mb-1">
                              {alert.type === 'emergency_stop' ? 'Emergency Stop Triggered' :
                               alert.type === 'risk_warning' ? 'Risk Warning' :
                               alert.type === 'system_error' ? 'System Error' :
                               alert.type === 'position_closed' ? 'Position Closed' :
                               'Alert'}
                            </Text>
