    ...
    >
      <span
        className={`transition-transform duration-200 ${
          active ? 'text-retro-turquoise' : 'group-hover:scale-110'
        }`}
      >
        {icon}
      </span>
...
export function Sidebar({ isOpen, onClose, user, onLogout }: SidebarProps) {
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 w-72 border-r-2 border-retro-brown flex flex-col backdrop-blur-xl bg-black/20 transition-transform duration-300 ${
