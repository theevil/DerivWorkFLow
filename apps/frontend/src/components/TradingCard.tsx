...
import { IconTrendingUp, IconTrendingDown, IconX, IconEdit, IconClock } from '@tabler/icons-react';
    ...
    <div className="card-elevated group">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <span className={`badge-${position.contract_type === 'CALL' ? 'success' : 'danger'}`}>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        <div className="neumorph-inset p-4 text-center">
          <p className="trading-card-label uppercase tracking-wide mb-1">Amount</p>
          <p className="trading-card-value">
            {formatCurrency(position.amount)}
          </p>
        </div>
        <div className="neumorph-inset p-4 text-center">
          <p className="trading-card-label uppercase tracking-wide mb-1">Entry Spot</p>
          <p className="trading-card-value">
            {position.entry_spot?.toFixed(5) || '--'}
          </p>
        </div>
        <div className="neumorph-inset p-4 text-center">
          <p className="trading-card-label uppercase tracking-wide mb-1">Current Spot</p>
          <p className="trading-card-value">
        ...
        <div className="neumorph-inset p-4 text-center">
          ...
          <div className={`flex items-center justify-center space-x-2 ${isProfit ? 'text-profit' : 'text-loss'}`}>
            {isProfit ? (
      ...
      {!isProfit && position.profit_loss !== undefined && position.profit_loss < 0 && (
