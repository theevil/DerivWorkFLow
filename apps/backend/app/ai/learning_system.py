...
from app.models.trading import TradePositionInDB, MarketAnalysisInDB, TradingSignalInDB
from app.crud.trading import get_user_positions, get_market_analysis_history
...
class HistoricalLearningSystem:
    ...
    def should_retrain(self, model_key: str) -> bool:
        ...
        return time_since_training.total_seconds() > settings.model_retrain_interval_hours * 3600
        ...
        try:
            ...
            for position in positions:
                ...
                if position.profit_loss:
                    symbol_performance[symbol]["profit"] += position.profit_loss
